...
public class CouponTemplateController {
    ...
    public Result<IPage<CouponTemplatePageQueryRespDTO>> pageQueryCouponTemplate(CouponTemplatePageQueryReqDTO reqDTO) {
        return Results.success(couponTemplateService.pageQueryCouponTemplate(reqDTO));
    }
